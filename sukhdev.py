...
Label = Label(main_screen, text="Sukhdev", bg="yellow", fg="red", font=("Comic Sans MS", 50))
Label.pack()
...
treeview_for_menu.insert('', 'end', text="1", values=('1', 'Aalo Parantha', '100'))
treeview_for_menu.insert('', 'end', text="2", values=('2', 'Paneer Parantha', '120'))
treeview_for_menu.insert('', 'end', text="3", values=('3', 'Roti', '30'))
treeview_for_menu.insert('', 'end', text="4", values=('4', 'Stuffed Naan', '60'))
treeview_for_menu.insert('', 'end', text="5", values=('5', 'Paneer-do-pyaaza', '260'))
treeview_for_menu.insert('', 'end', text="6", values=('6', 'Daal Balti', '240'))
treeview_for_menu.insert('', 'end', text="7", values=('7', 'Kadhai Paneer', '250'))
treeview_for_menu.insert('', 'end', text="8", values=('8', 'Malai Chaap', '260'))
treeview_for_menu.insert('', 'end', text="9", values=('9', 'Tandoori Chaap', '240'))
treeview_for_menu.insert('', 'end', text="10", values=('10', 'Deluxe Thaali', '400'))
